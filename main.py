...
if __name__ == '__main__':
    ...
    parser.add_argument('--case', required=True, choices=['atari', 'default'],
    ...
    parser.add_argument('--object_store_memory', type=int, default=16 * 1024 * 1024 * 1024, help='object store memory')
    ...
    elif args.case == 'default':
        from config.default import game_config
    else:
